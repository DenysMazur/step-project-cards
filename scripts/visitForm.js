...
export default class VisitForm extends Element{
  ...
  createForm() {
    ...
    const doctorsChoise = new Select('doctors', ['form__doctors', 'form-control', 'select', 'mt-1'], 'Выбрать врача', this.doctorsSelect);
  ...
  createFormOptions() {
    ...
    const descriptionVisit = new Input('text', ['visit__description', 'form-control', 'mt-1'], 'Краткое описание визита');
